...
const SettingsPage: React.FC = () => {
  ...
  const tabBtnRefs = React.useRef<Record<SettingsTab, HTMLButtonElement | null>>({
    ...
    <PageShell>
      ...
      <div className="mt-6 min-w-0 space-y-6">
        ...
        {(KEEP_MOUNTED || activeTab === "Content & Release") && (
          <div className={cn(!KEEP_MOUNTED && "block", KEEP_MOUNTED && activeTab !== "Content & Release" && "hidden")}>
